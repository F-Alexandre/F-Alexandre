...
<!--
**F-Alexandre/F-Alexandre** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
### 🧠 No que tenho focado e desenvolvido:

*   **Desenvolvimento Backend Robusto:** Criação de REST APIs limpas e performáticas utilizando **Spring Boot**, **Spring Security** (autenticação/autorização) e **Spring Data JPA**.
*   **Segurança Ofensiva e Defensiva:** Estudos práticos de análise de vulnerabilidades, quebra de escopo de aplicações web, automação de scripts de segurança em Python e mitigação de falhas arquiteturais.
*   **Aplicações Web Puristas:** Criação de Single Page Applications (SPAs) e lógicas visuais complexas utilizando **JavaScript Puro (Vanilla JS)** e Canvas.
...
<p align="left">
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=F-Alexandre&show_icons=true&theme=dracula&include_all_commits=true&count_private=true"/>
  <img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=F-Alexandre&layout=compact&langs_count=7&theme=dracula"/>
</p>
